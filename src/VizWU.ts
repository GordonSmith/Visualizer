...
export class VizWU extends Dermatology {
    wuDashboard;
    _resetButton;
...
VizWU.prototype._class += " VizWU";

export interface VizWU {
    espUrl(): string;
...
VizWU.prototype.publish("espUrl", null, "string", "ESP Url");
VizWU.prototype.publish("espCache", null, "string", "ESP Cache");
